...
3.  Using the Maximum Likelihood estimates $(\hat{\alpha}_j, \hat{\beta}_j),j=1,2,3$ calculate the expected proportion of dead beetles for each concentration. Compare the results with the raw proportions (`numberDied`/`numberExposed`) of the data and visualise the results in an appropriate plot.
...
4.  Think about how to determine which of the three models has the best ﬁt to the observed proportions.
