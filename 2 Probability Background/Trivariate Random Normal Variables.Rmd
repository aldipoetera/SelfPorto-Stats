...
```{r}
mu_A <- c(3.0)
sigma_AA <- matrix(data = 1, nrow = 1, ncol = 1)
sigma_AB <- matrix(data = c(0.6, 0.6), nrow = 1, ncol = 2)
sigma_BA <- matrix(data = c(0.6, 0.6), nrow = 2, ncol = 1)
sigma_BB <- matrix(data = c(1, 0.6, 0.6, 1), nrow = 2, ncol = 2)
