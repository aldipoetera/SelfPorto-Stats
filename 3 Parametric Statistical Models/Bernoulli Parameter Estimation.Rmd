...
The next checks whether our estimation is accurate. It seems that the minimax parameter is quite consistent, but is still close towards our target parameter.
...
for(i in 1:10000){
  y = rbinom(1, 1000, 0.7)
  mean_est <- estimator(y, 31.62278, 11.57973, 1000)
  real_est <- y/1000
